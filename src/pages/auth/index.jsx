...
const Auth = () => {
  ...
  const validateSignup = () => {
    ...
    if (password !== confirmPassword) {
      ...
      console.log("Password and Confirm password shoud be same!")
  ...
  return (
    <div className="h-[100vh] w-[100vw] flex items-center justify-center">
      <div className="h-[90vh] bg-white border-2 border-green-100 text-opacity-90 shadow-2xl w-[80vw] md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2">
        <div className="flex flex-col gap-10 items-center justify-center">
          <div className="flex items-center justify-center flex-col">
            ...
            <p className="font-small sm:font-medium text-center px-3">Fill in the details to get started with your personal chat app!</p>
          </div>
